...
<!--each row-->
<tr id="payment_<?php echo e($payment->payment_id); ?>" class="<?php echo e($payment->pinned_status ?? ''); ?>">
        ...
        <span class="list-table-action font-size-inherit">
            ...
            <span class="list-table-action">
                <a href="javascript:void(0);" title="<?php echo e(cleanLang(__('lang.pinning'))); ?>"
                    data-parent="payment_<?php echo e($payment->payment_id); ?>" data-url="<?php echo e(url('/payments/'.$payment->payment_id.'/pinning')); ?>"
...
<!--each row-->
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php /**PATH C:\xampp\htdocs\growcrm\application\resources\views/pages/payments/components/table/ajax.blade.php ENDPATH**/ ?>