        ...
        <div class="form-group row">
            ...
            <div class="col-sm-12 col-lg-9">
                <!-- <input type="text" class="form-control form-control-sm" id="email" name="email"
                    ...
                    <input type="email" class="form-control form-control-sm <?php echo e($errors->has('email') ? 'error' : ''); ?>" 
                    id="email" name="email" placeholder="" value="<?php echo e(old('email', $user->email ?? '')); ?>" 
                    required>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-12 col-lg-9">
                <input type="text" class="form-control form-control-sm" id="phone" name="phone"
                    value="<?php echo e($user->phone ?? ''); ?>" required pattern="[0-9]*">
            </div>
        </div>
        <!--/#[edit] phone-->
