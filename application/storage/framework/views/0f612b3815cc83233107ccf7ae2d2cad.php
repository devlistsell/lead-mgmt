...
<tr id="lead_<?php echo e($lead->lead_id); ?>" class=" <?php echo e($lead->pinned_status ?? ''); ?>">
    ...
    <td class="leads_col_action actions_column" id="leads_col_action_<?php echo e($lead->lead_id); ?>">
        ...
        <!--action button-->
        <!--more button (team)-->
        <?php if(config('visibility.action_buttons_edit') && auth()->user()->role->role_id == '1'): ?> 
            <span class="list-table-action dropdown font-size-inherit">
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<!--each row--><?php /**PATH C:\xampp\htdocs\growcrm\application\resources\views/pages/leads/components/table/ajax.blade.php ENDPATH**/ ?>