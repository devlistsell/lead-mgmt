<div class="row">
    <div class="col-lg-12">
        ...
        <div class="form-group row">
            <label
                class="col-sm-12 col-lg-3 text-left control-label col-form-label required"><?php echo e(cleanLang(__('lang.telephone'))); ?></label>
            <div class="col-sm-12 col-lg-9">
                <input type="text" class="form-control form-control-sm" id="lead_phone" name="lead_phone" placeholder=""
                    value="<?php echo e($lead->lead_phone ?? ''); ?>" required pattern="[0-9]*">
            </div>
        </div>
        <!--email-->
        <div class="form-group row">
            ...
            <div class="col-sm-12 col-lg-9">
                <input type="email" class="form-control form-control-sm <?php echo e($errors->has('lead_email') ? 'error' : ''); ?>" 
                    id="lead_email" name="lead_email" placeholder="" value="<?php echo e(old('lead_email', $lead->lead_email ?? '')); ?>" 
                    required>
            <?php if($errors->has('lead_email')): ?>
                <span class="text-danger"><?php echo e($errors->first('lead_email')); ?></span>
            <?php endif; ?>
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-12 col-lg-9">
                <input type="number" class="form-control form-control-sm" id="lead_value" name="lead_value"
                    placeholder="" value="<?php echo e($lead->lead_value ?? ''); ?>" required>
            </div>
        </div>
